#!/usr/bin/env python3
"""
Simplified local version of the LogStory Regex Visualizer.
This version does not require authentication or Google Cloud Storage.
...
def index():
    ...
    return render_template('index_simple.html', log_types=log_types)
